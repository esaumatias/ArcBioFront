        ...
        <div className="containerFundadores">
          <div className="left">
            ...
            <div className="containerText">
              <span>
                Com mais de <strong>12 anos de experiência</strong>, a ArcBio é
                especialista em criar refúgios exclusivos de alto padrão, unindo
                design personalizado, funcionalidade e estratégias inteligentes.
              </span>
              ...
              <span>
                ...
                Cristina Lapas, a ArcBio combina <strong>arquitetura</strong> e{" "}
                <strong>meio ambiente</strong> de forma singular. Após deixarem
                os grandes centros urbanos, encontraram na Praia de Pipa - RN o
                lugar perfeito para transformar sonhos em projetos que
                harmonizam estética, natureza e sustentabilidade.
              </span>
